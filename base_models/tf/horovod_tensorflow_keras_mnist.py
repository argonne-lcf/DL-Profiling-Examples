# Taken from:
# https://github.com/horovod/horovod/blob/v0.18.1/examples/tensorflow_keras_mnist.py
...
# create custom session config to accomodate different architectures
...
datapath = os.path.dirname(os.path.realpath(__file__)) + '/mnist.tgz'
